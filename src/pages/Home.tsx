		...
		<>
			...
			<div className="mt-36 outer-container">
				<div className="inner-container flex flex-col items-center ">
					...
					<h1 className="text-3xl font-bold text-center w-137">
			...
			<div className="mt-36 outer-container">
				<div className="inner-container flex flex-col items-center">
					<div className="shadow-[4px_4px_0px_var(--color-gray)] animate-float-pixel border-black border-5 w-2xl flex flex-col gap-4 justify-center items-center py-10">
						<h1 className="text-primary text-3xl font-bold text-center">
							Ready for a New Adventure?
						</h1>
						<p className="font-bold textxl text-center w-3/4">
